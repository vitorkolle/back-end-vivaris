...
exports.SUCCESS_UPDATED_ITEM = exports.SUCCESS_DELETED_ITEM = exports.SUCCESS_CREATED_ITEM = exports.ERROR_NOT_FOUND_APPOINTMENTS = exports.ERROR_INVALID_AUTH_TOKEN = exports.ERROR_INVALID_PAYMENT_METHOD_ID = exports.ERROR_INVALID_CARD = exports.ERROR_NOT_DELETED = exports.ERROR_ALREADY_EXISTS_PROFESSIONAL_AVAILBILITY = exports.ERROR_AGE_NOT_VALID = exports.ERROR_DATE_NOT_VALID = exports.ERROR_ALREADY_EXISTS_ACCOUNT_CIP = exports.ERROR_ALREADY_EXISTS_ACCOUNT_CPF = exports.ERROR_ALREADY_EXISTS_ACCOUNT_EMAIL = exports.ERROR_NOT_UPDATED = exports.ERROR_NOT_CREATED = exports.ERROR_INTERNAL_SERVER = exports.ERROR_CONTENT_TYPE = exports.ERROR_INTERNAL_SERVER_DB = exports.ERROR_NOT_FOUND_EMOTION = exports.ERROR_ALREADY_EXISTS_EMOTION = exports.ERROR_ALREADY_EXISTS_PREFRENCE = exports.ERROR_NOT_FOUND_AVAILBILITY = exports.ERROR_NOT_FOUND_PREFERENCE = exports.ERROR_NOT_FOUND_CLIENT = exports.ERROR_NOT_FOUND_PROFESSIONAL = exports.ERROR_NOT_FOUND_ASSESSMENT = exports.ERROR_NOT_FOUND = exports.ERROR_REQUIRED_FIELDS = exports.ERROR_INVALID_ID = void 0;
...
exports.ERROR_NOT_FOUND_ASSESSMENT = { status: false, status_code: 404, message: 'Não foram encontradas consultas na requisição!!' };
exports.ERROR_NOT_FOUND_PROFESSIONAL = { status: false, status_code: 404, message: 'Não foram encontrados psicólogos na requisição!!' };
exports.ERROR_NOT_FOUND_CLIENT = { status: false, status_code: 404, message: 'Não foram encontrados clientes na requisição!!' };
...
exports.ERROR_ALREADY_EXISTS_EMOTION = { status: false, status_code: 400, message: 'A emoção já existe!!' };
exports.ERROR_NOT_FOUND_EMOTION = { status: false, status_code: 404, message: 'Não foram encontradas emoções na requisição!!' };
...
exports.ERROR_NOT_UPDATED = { status: false, status_code: 500, message: 'Não foi possível processar a requisição devido à algum problema com os dados recebidos!!' };
...
exports.ERROR_NOT_FOUND_APPOINTMENTS = { status: false, status_code: 404, message: 'Não foram encontradas consultas na requisiçã!' };
exports.ERROR_CONFLICT_APPOINTMENT = { status: false, status_code: 409, message: 'Agendamento indisponível! Já existe uma consulta marcada para o mesmo horário.' };
