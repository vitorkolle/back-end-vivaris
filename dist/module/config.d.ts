...
declare const ERROR_INVALID_PAYMENT_METHOD_ID: {
    status: boolean;
    status_code: number;
    message: string;
};
...
export { ERROR_INVALID_ID, ERROR_REQUIRED_FIELDS, ERROR_NOT_FOUND, ERROR_CONTENT_TYPE, ERROR_INTERNAL_SERVER_DB, SUCCESS_CREATED_ITEM, SUCCESS_DELETED_ITEM, SUCCESS_UPDATED_ITEM, ERROR_NOT_CREATED, ERROR_NOT_FOUND_PREFERENCE, ERROR_ALREADY_EXISTS_PREFRENCE, ERROR_ALREADY_EXISTS_ACCOUNT_CPF, ERROR_ALREADY_EXISTS_ACCOUNT_EMAIL, ERROR_DATE_NOT_VALID, ERROR_ALREADY_EXISTS_ACCOUNT_CIP, ERROR_AGE_NOT_VALID, ERROR_NOT_FOUND_PROFESSIONAL, ERROR_NOT_FOUND_AVAILBILITY, ERROR_ALREADY_EXISTS_PROFESSIONAL_AVAILBILITY, ERROR_NOT_DELETED, ERROR_INVALID_PAYMENT_METHOD_ID };
