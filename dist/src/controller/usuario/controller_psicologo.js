...
exports.setAtualizarPsicologo = setAtualizarPsicologo;
...
const controller_usuario_1 = require("./controller_usuario");
...
function setAtualizarPsicologo(user, contentType, id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (String(contentType).toLowerCase() !== 'application/json') {
                return config_1.ERROR_CONTENT_TYPE;
            ...
            if (!user.nome || !(0, zod_validations_1.isValidName)(user.nome) ||
                ...
                !user.senha || !(0, zod_validations_1.isValidPassword)(user.senha) ||
                !user.telefone || user.telefone.length !== 11 || typeof user.telefone !== 'string' ||
                !user.id_sexo || !(0, zod_validations_1.isValidId)(user.id_sexo) || !(0, controller_usuario_1.getBuscarSexo)(user.id_sexo)) {
                if (!validarData(user.data_nascimento.toString())) {
                    return config_1.ERROR_DATE_NOT_VALID;
                }
                if (validarIdade(user.data_nascimento) < 18) {
            ...
            let validatePsicologo = yield (0, usuario_1.buscarPsicologo)(id);
            if (!validatePsicologo) {
                return config_1.ERROR_NOT_FOUND;
            }
            const updatedPsicologo = yield (0, usuario_1.atualizarPsicologo)(id, inputData);
            if (!updatedPsicologo) {
